...
mux.HandleFunc("POST /api/workspaces/pick", s.handlePickWorkspace)
	...
	mux.HandleFunc("GET /api/workspaces/{workspace_id}/completions", s.handleCompletions)
	mux.HandleFunc("GET /api/workspaces/{workspace_id}/model-options", s.handleModelOptions)
	mux.HandleFunc("POST /api/workspaces/{workspace_id}/model", s.handleModelSelect)
mux.HandleFunc("GET /api/workspaces/{workspace_id}/trace/{event_id}", s.handleTraceDetail)
